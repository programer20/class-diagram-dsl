...
<model ref="r:1690804b-db9b-46c1-b4cb-59479a6a6d36(ClassDiagramDSL.editor)">
  ...
  <node concept="24kQdi" id="2wxCA3QWoE4">
    <ref role="1XX52x" to="rc6d:2wxCA3QWoDQ" resolve="ClassDiagramRepository" />
    <node concept="3EZMnI" id="2wxCA3QWoE6" role="2wV5jI">
      <node concept="3F2HdR" id="2wxCA3QWoEd" role="3EZMnx">
        <ref role="1NtTu8" to="rc6d:2wxCA3QWoDU" resolve="classDiagrams" />
        <node concept="2iRkQZ" id="2wxCA3QWoEf" role="2czzBx" />
      </node>
      <node concept="2iRkQZ" id="2wxCA3QWoE9" role="2iSdaV" />
    </node>
  </node>
  ...
  <node concept="24kQdi" id="5JGbHHiNYTj">
    ...
    <node concept="3EZMnI" id="5JGbHHiNYTl" role="2wV5jI">
      ...
      <node concept="3F0ifn" id="5JGbHHiNYVm" role="3EZMnx">
        <property role="3F0ifm" value="&quot;" />
        <node concept="11L4FC" id="5JGbHHiO8MY" role="3F10Kt">
          <property role="VOm3f" value="true" />
        </node>
        <node concept="pkWqt" id="5JGbHHiPaLZ" role="pqm2j">
          <node concept="3clFbS" id="5JGbHHiPaM0" role="2VODD2">
            <node concept="3clFbF" id="5JGbHHiPaMp" role="3cqZAp">
              <node concept="2OqwBi" id="5JGbHHiPbsz" role="3clFbG">
                <node concept="2OqwBi" id="5JGbHHiPaZR" role="2Oq$k0">
                  <node concept="pncrf" id="5JGbHHiPaMo" role="2Oq$k0" />
                  <node concept="3TrcHB" id="5JGbHHiPbax" role="2OqNvi">
                    <ref role="3TsBF5" to="rc6d:5JGbHHiNYT2" resolve="cardinality2" />
                  </node>
                </node>
                <node concept="17RvpY" id="5JGbHHiPbx_" role="2OqNvi" />
              </node>
            </node>
          </node>
        </node>
